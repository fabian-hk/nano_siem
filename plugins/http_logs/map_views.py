...
def overview_map_view(request):
    ...
    return render(request, "http_logs/overview_map_view.html", context)
...
class MarkerPoint:
    ...
    def pop_up(self):
        ...
        return render_to_string("http_logs/detailed_map_view_table.html", variables)
...
def detailed_map_view(request):
    ...
    return render(request, "http_logs/detailed_map_view.html", context=context)
