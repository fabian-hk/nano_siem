...
def send_notifications():
    overwatch_notify = overwatch.sent_notifications()
    ...
    if overwatch_notify:
        data.update(overwatch.get_data_as_table())
    ...
    if data:
        ...
        text = "There are new events in the Nano SIEM system. Login to your Nano SIEM instance to see the details."
